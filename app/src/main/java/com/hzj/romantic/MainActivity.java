...
public class MainActivity extends AppCompatActivity {
    ...
    private void init_view() {
        ...
        use_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!load_result) {
                    Toast.makeText(MainActivity.this, "请先加载模型", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void load_model(String model) {
        try {
            ...
            Toast.makeText(MainActivity.this, model + "模型加载成功", Toast.LENGTH_SHORT).show();
            Log.d(TAG, model + "模型加载成功");
            tflite.setNumThreads(4);
            load_result = true;
        } catch (IOException e) {
            Toast.makeText(MainActivity.this, model + "加载模型失败", Toast.LENGTH_SHORT).show();
            Log.d(TAG, model + "加载模型失败");
            load_result = false;
            e.printStackTrace();
        }
    }
    ...
    private void predict_image(String image_path) {
        ...
        try {
            ...
            String name = resultLabel.get(r);
            float probability = results[r];
